...
class _StringsAppTitleEn {
  ...
  // Translations
  String get parta => 'Asi';
  String get partb => 'mov';
}
...
class _StringsSettingEn {
  ...
  late final _StringsSettingBrightnessEn brightness =
      _StringsSettingBrightnessEn._(_root);
  late final _StringsSettingLanguageEn language =
      _StringsSettingLanguageEn._(_root);
  late final _StringsSettingReceiveEn receive =
      _StringsSettingReceiveEn._(_root);
...
class _StringsSettingBrightnessEn {
  ...
  late final _StringsSettingBrightnessThemeModeEn themeMode =
      _StringsSettingBrightnessThemeModeEn._(_root);
}
...
class _StringsSettingLanguageEn {
  ...
  String subTitle({required Object language}) =>
...
class _StringsSettingCoreEn {
  ...
  late final _StringsSettingCoreServerEn server =
      _StringsSettingCoreServerEn._(_root);
}
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'setting.common':
        return 'Common';
      case 'setting.brightness.title':
        return 'Brightness';
      case 'setting.brightness.subTitle':
        return ({required Object mode}) => 'Current mode: ${mode}';
      case 'setting.brightness.themeMode.system':
        return 'Follow system';
      case 'setting.brightness.themeMode.light':
        return 'Light mode';
      case 'setting.brightness.themeMode.dark':
        return 'Dark mode';
      case 'setting.language.title':
        return 'Language';
      case 'setting.language.subTitle':
        return ({required Object language}) => 'Current language: ${language}';
      case 'setting.receive.title':
        return 'Receive';
      case 'setting.receive.quickSave':
        return 'Quick Save';
      case 'setting.receive.quickSaveHint':
        return 'Start tranfer without accept';
      case 'setting.receive.saveFolder':
        return 'Save Folder';
      case 'setting.receive.selectSaveFolder':
        return 'Select';
      case 'setting.core.title':
        return 'core setting';
      case 'setting.core.server.title':
        return 'server';
      default:
        return null;
    }
